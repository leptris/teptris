...
TEST(Datetime, JsonValue)
{
    struct {
        ...
        {"a = 07:32", R"({"a":{"type":"time-local","value":"07:32:00"}})"},
        {"a = 1979-05-27T07:32", R"({"a":{"type":"datetime-local","value":"1979-05-27T07:32:00"}})"},
        {"a = 1979-05-27 07:32Z", R"({"a":{"type":"datetime","value":"1979-05-27T07:32:00Z"}})"},
...
TEST(Datetime, Invalid)
{
    const char *bad[] = {
        ...
        "a = 1979-05-27T07:32:00+25:00", "a = 25:00:00", "a = 1979-05-27T07:32:9",
    };
