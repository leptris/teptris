...
const teptris_node *teptris_node_array_at(const teptris_node *node, size_t index);

/* Iteration is in insertion order. */
size_t teptris_node_table_length(const teptris_node *node);
const teptris_node *teptris_node_table_at(const teptris_node *node, size_t index,
...
teptris_status teptris_document_emit(const teptris_document *doc,
                                     char **buf, size_t *len);
